...
plt.legend()
plt.savefig(os.path.join(base_dir, 'result', 'cnn_lstm_attention_train_and_test.jpg'), bbox_inches='tight', dpi = 600)
plt.show()
...
plt.ylabel('B')
plt.legend()
plt.savefig(os.path.join(base_dir, 'result', 'cnn_lstm_attention_pred_train.jpg'), bbox_inches='tight', dpi = 600)
plt.show()
...
plt.ylabel('B')
plt.legend()
plt.savefig(os.path.join(base_dir, 'result', 'cnn_lstm_attention_pred_test.jpg'), bbox_inches='tight', dpi = 600)
plt.show()
...
df.to_excel(os.path.join(base_dir, 'result', 'cnn_lstm_attention.xlsx'), index=False)
