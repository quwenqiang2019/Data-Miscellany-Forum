...
# 创建滑动窗口数据集
X_train, Y_train = createXY(train_data_scaler, window_size)
X_test, Y_test = createXY(test_data_scaler, window_size)
...
attention = attention_block(my_model, window_size)
