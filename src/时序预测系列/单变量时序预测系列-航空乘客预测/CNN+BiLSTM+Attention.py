...
# 创建滑动窗口数据集
X_train, Y_train = createXY(train_data_scaler, look_back)
X_test, Y_test = createXY(test_data_scaler, look_back)
...
my_model=Bidirectional(LSTM(lstm_units, activation='tanh', return_sequences=True), name='bilstm')(my_model)      #双向LSTM层
