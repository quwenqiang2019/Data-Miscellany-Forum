...
lasso_coefficients_df.to_excel(os.path.join(base_dir, 'result', 'lasso特征重要性排序.xlsx'))
# 可视化特征系数
...
plt.ylabel('Feature')
plt.tight_layout()
plt.savefig(os.path.join(base_dir, 'result', 'lasso.jpg'), bbox_inches='tight', dpi=600)
plt.show()
