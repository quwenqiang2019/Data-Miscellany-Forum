...
importance_df.to_excel(os.path.join(base_dir, 'result', 'Adaboost特征重要性排序.xlsx'))
# 可视化特征重要性
...
plt.ylabel('Feature')
plt.tight_layout()
plt.savefig(os.path.join(base_dir, 'result', 'Adaboost.jpg'), bbox_inches='tight', dpi=600)
plt.show()